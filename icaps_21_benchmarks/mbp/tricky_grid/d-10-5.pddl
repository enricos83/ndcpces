(define (domain alban_10_5) 
  ...
  (:action check
    ...
    :effect (and
      ...
      (when (and (atx x_0) (aty y_4)) (and (not (alive))))
      ...
      (when (and (atx x_5) (aty y_4)) (and (not (alive))))
      (when (and (atx x_6) (aty y_4)) (and (not (alive))))
      (when (and (atx x_7) (aty y_4)) (and (not (alive))))
      (when (and (atx x_8) (aty y_4)) (and (not (alive))))
      (when (and (atx x_9) (aty y_4)) (and (not (alive))))
