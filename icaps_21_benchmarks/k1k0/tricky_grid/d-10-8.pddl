(define (domain alban_10_8) 
  ...
  (:action check
    ...
    :effect (and
      ...
      (when (and (atx x_0) (aty y_7)) (and (not (alive))))
      (when (and (atx x_1) (aty y_7)) (and (not (alive))))
      (when (and (atx x_2) (aty y_7)) (and (not (alive))))
      (when (and (atx x_3) (aty y_7)) (and (not (alive))))
      (when (and (atx x_4) (aty y_7)) (and (not (alive))))
      (when (and (atx x_5) (aty y_7)) (and (not (alive))))
      (when (and (atx x_6) (aty y_7)) (and (not (alive))))
      (when (and (atx x_7) (aty y_7)) (and (not (alive))))
      (when (and (atx x_8) (aty y_7)) (and (not (alive))))
      (when (and (atx x_9) (aty y_7)) (and (not (alive))))
      (when (and (atx x_0) (aty y_0)) (and (not (alive))))
      (when (and (atx x_9) (aty y_0)) (and (not (alive))))
    )
  )
  (:action move_up
   :parameters ()
   ...
   :effect (and
     (not (can_move)) (has_to_check)
      ...
      (when (aty y_5) (and (not (aty y_5)) (aty y_6)))
      (when (aty y_6) (and (not (aty y_6)) (aty y_7)))
    )
  )
  (:action move_down
   :parameters ()
   ...
   :effect (and
     (not (can_move)) (has_to_check)
      ...
      (when (aty y_6) (and (not (aty y_6)) (aty y_5)))
      (when (aty y_7) (and (not (aty y_7)) (aty y_6)))
    )
  )
  (:action move_left
   :parameters ()
   ...
   :effect (and
     (not (can_move)) (has_to_check)
      ...
      (when (atx x_9) (and (not (atx x_9)) (atx x_8)))
    )
  )
  (:action move_right
   :parameters ()
   ...
   :effect (and
     (not (can_move)) (has_to_check)
      ...
      (when (atx x_8) (and (not (atx x_8)) (atx x_9)))
      ...
      (when (aty y_5) (oneof (aty y_5) (and (not (aty y_5)) (aty y_6))))
      (when (aty y_6) (oneof (aty y_6) (and (not (aty y_6)) (aty y_7))))
    )
  )
)
;; KTHXBAY
