(define (domain alban_10_7) 
  ...
  (:action check
    ...
    :effect (and
      ...
      (when (and (atx x_0) (aty y_6)) (and (not (alive))))
      (when (and (atx x_1) (aty y_6)) (and (not (alive))))
      (when (and (atx x_2) (aty y_6)) (and (not (alive))))
      (when (and (atx x_3) (aty y_6)) (and (not (alive))))
      (when (and (atx x_4) (aty y_6)) (and (not (alive))))
      (when (and (atx x_5) (aty y_6)) (and (not (alive))))
      (when (and (atx x_6) (aty y_6)) (and (not (alive))))
      (when (and (atx x_7) (aty y_6)) (and (not (alive))))
      (when (and (atx x_8) (aty y_6)) (and (not (alive))))
      (when (and (atx x_9) (aty y_6)) (and (not (alive))))
